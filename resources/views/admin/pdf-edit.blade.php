...
@section('title') Edit PDF @endsection
...
@section('content')
    <div id="pdf" class="edit-file" data-file="{{ json_encode($file) }}">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="#" method="POST" id="formUploadPdf" enctype="multipart/form-data" @submit.prevent="submitUpdatePdf">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <input type="hidden" name="prevfile" value="{{ (!empty($file->file))? $file->file->name : '' }}">
