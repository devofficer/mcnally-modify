            ...
            <div class="col-12 col-lg-6 fullwidth-split-image bg-dark d-flex justify-content-center align-items-center">
              ...
              <div class="col-12 col-sm-8 col-lg-9 text-center pt-5 pb-5">
                ...
                <div class="card text-left">
                  <div class="card-body">
                    <div class="media">
                      <img alt="Image" src="/assets_front/img/avatar-female-2.jpg" class="avatar" />
            ...
            <div class="col-12 col-sm-8 col-lg-6 fullwidth-split-text">
              <div class="col-12 col-lg-8 align-self-center">
                ...
                <form class="mb-4">
                  ...
                  <div>
                    <small>Forgot password? <a class="text-primary" href="ForgotPassword">Reset here</a></small><br>
                  </div>
               ...
               <button type="submit" class="btn btn-lg btn-success">Sign in</button>
                ...
                <div class="text-center">
                  ...
                  <span class="text-small">Don't have an account yet? <a href="/register_step1.php">Create one</a>
                  </span>
                </div>
              </div>
              <!--end of col-->
