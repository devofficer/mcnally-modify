    ...
    $('#chaining-alert-new').click(function () {
      Swal.mixin({
        ...
        if (result.value) {
          Swal.fire({
            title: 'All done!',
            html: 'Your alert: <pre><code>' + JSON.stringify(result.value) + '</code></pre>',
...
module.exports = __webpack_require__(/*! /home/jbosapps/nally.jbosapps.com/admin/resources/js/pages/sweet-alerts.init.js */"./resources/js/pages/sweet-alerts.init.js");
